...
-- ============================================================
-- CTD TABULATED SUMMARY DRAFTS + APPROVALS
-- ============================================================

CREATE TABLE IF NOT EXISTS ncd_ctd_tabulated_summary (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    ...
    user_comment TEXT NULL,
    previous_id UUID NULL
        REFERENCES ncd_ctd_tabulated_summary(id),
...
CREATE INDEX IF NOT EXISTS idx_ncd_ctd_tabulated_summary_section
    ON ncd_ctd_tabulated_summary(tenant_id, project_id, bucket, section_number);

CREATE INDEX IF NOT EXISTS idx_ncd_ctd_tabulated_summary_status
    ON ncd_ctd_tabulated_summary(status);
